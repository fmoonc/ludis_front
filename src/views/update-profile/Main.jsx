                ...
                <div className="flex-1 mt-6 xl:mt-0">
                  <div className="grid grid-cols-12 gap-x-5">
                    ...
                    <div className="col-span-12">
                      <div className="mt-3">
                        <label
                          htmlFor="update-adress-user"
                          className="form-label"
                        >
                          Address
                        </label>
                        <textarea
                          id="update-adress-user"
                          className="form-control"
                          placeholder="Adress"
            ...
            <div className="p-5">
              <div className="grid grid-cols-12 gap-x-5">
                ...
                <div className="col-span-12 xl:col-span-6">
                  ...
                  <div className="mt-3">
                    <label
                      htmlFor="3update-profile-form-14"
                      className="form-label"
                    >
                      Bank Name
                    </label>
                    <TomSelect
                      id="update-profile-form-14"
                      value={select}
                      onChange={setSelect}
                      className="w-full"
                    >
                  ...
                  <div className="mt-3">
                    <label
                      htmlFor="update-profile-form-15"
                      className="form-label"
                    >
                      Bank Account
                    </label>
                    <input
                      id="update-profile-form-15"
                      type="text"
                      className="form-control"
                      placeholder="Input text"
